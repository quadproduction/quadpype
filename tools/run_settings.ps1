<#
.SYNOPSIS
  Helper script to QuadPype Settings UI

.DESCRIPTION
  This script will run QuadPype and open Settings UI.
...
& "$env:POETRY_HOME\bin\poetry" run python "$($quadpype_root)\start.py" settings --dev
