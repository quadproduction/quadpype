"""Dummy environment that allows importing QuadPype modules and run
...
is expected there that environment is handled by QuadPype itself.
...
This setting of env vars is necessary to run before any imports of QuadPype code!
