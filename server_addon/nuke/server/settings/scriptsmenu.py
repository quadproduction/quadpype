...
DEFAULT_SCRIPTSMENU_SETTINGS = {
    ...
    "definition": [
        ...
        },
        {
            ...
            "command": "from quadpype.hosts.nuke.startup.frame_setting_for_read_nodes import main;main();",  # noqa
        ...
        },
        {
            ...
            "command": "from quadpype.hosts.nuke.startup.custom_write_node import main;main();",  # noqa
