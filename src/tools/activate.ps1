...
$PATH_ACTIVATE_SCRIPT=$ExecutionContext.SessionState.Path.GetUnresolvedProviderPathFromPSPath("$($PATH_QUADPYPE_ROOT)\.venv\Scripts\activate.ps1")
...
[System.Environment]::SetEnvironmentVariable("POETRY_HOME", "$($PATH_QUADPYPE_ROOT)\.poetry", [System.EnvironmentVariableTarget]::User)
