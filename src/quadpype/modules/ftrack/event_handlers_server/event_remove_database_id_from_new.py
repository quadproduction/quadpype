...
class RemoveDatabaseIdFromNew(BaseEvent):
    """
    ...
    Priority of this event must be less than SyncToDatabase event
    """
    priority = SyncToDatabaseEvent.priority - 1
    ignore_me = True
...
def register(session):
    ...
    RemoveDatabaseIdFromNew(session).register()
