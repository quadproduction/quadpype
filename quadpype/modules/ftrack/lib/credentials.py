...
from quadpype.lib import QuadPypeSecureRegistry
...
def get_credentials(ftrack_server=None):
    ...
    username_registry = QuadPypeSecureRegistry(username_name)
    api_key_registry = QuadPypeSecureRegistry(api_key_name)
